...
partial model element1D
  "parital water vapour and heat transfer model, Partial water mass transfer element with two WaterMassPort connectors that does not store energy"
...
public
  ...
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_b HeatPort_b annotation (Placement(transformation(extent={{90,10},
            {110,30}},rotation=0)));
  solarGreenhouseV2.Interfaces.WaterMassPort_a MassPort_a
    annotation (Placement(transformation(extent={{-110,-30},{-90,-10}},
          rotation=0)));
  solarGreenhouseV2.Interfaces.WaterMassPort_b MassPort_b
