...
model fullGreenhouse "greenhouse example"
  ...
  parameter greenhouseParameters Params( Rsi_subsoil_insulation = 40 / 5.67, Rsi_wall_insulation = 40 / 5.67, blanket_Rsi = 40 / 5.67,
    glazing_FIR_transmission=0.03,
    glazing_emissivity=0.9,                                                                                                                                                                   heater_max_power = 1, max_ACH = 2000, outside_albedo_NIR = 0.9,outside_albedo_PAR = 0.9, soil_depth = 1, soil_emissivity = 1, wall_thickness = 0.0001) annotation (
