...
model panelDiffuse "port_a (filled) to outside, port_b (unfilled) to inside.
...
//light
  ...
  Modelica.Units.SI.HeatFlux direct_flux_incident_PAR;
  Modelica.Units.SI.HeatFlux direct_flux_incident_NIR;

  Modelica.Units.SI.HeatFlux direct_flux_after_1_layer_PAR "flux through panel single layer glazing, not including structural fraction";
  Modelica.Units.SI.HeatFlux direct_flux_after_2_layer_PAR "flux through panel single layer glazing, not including structural fraction";
  Modelica.Units.SI.HeatFlux direct_flux_after_1_layer_NIR "flux through panel single layer glazing, not including structural fraction";
  Modelica.Units.SI.HeatFlux direct_flux_after_2_layer_NIR "flux through panel single layer glazing, not including structural fraction";

  Modelica.Units.SI.HeatFlux diffuse_flux_after_1_layer_PAR "flux through panel single layer glazing, not including structural fraction";
  Modelica.Units.SI.HeatFlux diffuse_flux_after_2_layer_PAR "flux through panel single layer glazing, not including structural fraction";
  Modelica.Units.SI.HeatFlux diffuse_flux_after_1_layer_NIR "flux through panel single layer glazing, not including structural fraction";
  Modelica.Units.SI.HeatFlux diffuse_flux_after_2_layer_NIR "flux through panel single layer glazing, not including structural fraction";


  Modelica.Units.SI.HeatFlowRate diffuse_power_transmitted_PAR "power through panel, not including blanket state ";
  Modelica.Units.SI.HeatFlowRate diffuse_power_transmitted_NIR "power through panel, not including blanket state ";
  Modelica.Units.SI.HeatFlowRate direct_power_transmitted_PAR "power through panel, not including blanket state ";
  Modelica.Units.SI.HeatFlowRate direct_power_transmitted_NIR "power through panel, not including blanket state ";
...
//determine panel light transmission
  ...
  direct_flux_incident_PAR = Dni*C.PAR_fraction_insolation;
  direct_flux_incident_NIR = Dni*C.NIR_fraction_insolation;

  //outer film layer:
  direct_flux_after_1_layer_PAR = direct_flux_incident_PAR*solarGreenhouseV2.Functions.Direct_2interface( P.n_index, P.panel_azimuths[i],  P.panel_zeniths[i], sun_azimuth, sun_zenith)*( 1 - P.haze);
  diffuse_flux_after_1_layer_PAR= direct_flux_incident_PAR*solarGreenhouseV2.Functions.Direct_2interface( P.n_index, P.panel_azimuths[i],  P.panel_zeniths[i], sun_azimuth, sun_zenith)*(P.haze) +
    diffuse_flux_incident_PAR*P.panel_single_glazed_diffuse_transmissions[i];

  direct_flux_after_1_layer_NIR = direct_flux_incident_NIR*solarGreenhouseV2.Functions.Direct_2interface( P.n_index, P.panel_azimuths[i],  P.panel_zeniths[i], sun_azimuth, sun_zenith)*( 1 - P.haze);
  diffuse_flux_after_1_layer_NIR= direct_flux_incident_NIR*solarGreenhouseV2.Functions.Direct_2interface( P.n_index, P.panel_azimuths[i],  P.panel_zeniths[i], sun_azimuth, sun_zenith)*(P.haze) +
    diffuse_flux_incident_NIR*P.panel_single_glazed_diffuse_transmissions[i];

  //innner film layer
  direct_flux_after_2_layer_PAR = direct_flux_after_1_layer_PAR*solarGreenhouseV2.Functions.Direct_2interface( P.n_index, P.panel_azimuths[i],  P.panel_zeniths[i], sun_azimuth, sun_zenith)*( 1 - P.haze);
  diffuse_flux_after_2_layer_PAR= direct_flux_after_1_layer_PAR*solarGreenhouseV2.Functions.Direct_2interface( P.n_index, P.panel_azimuths[i],  P.panel_zeniths[i], sun_azimuth, sun_zenith)*(P.haze) +
    diffuse_flux_after_1_layer_PAR*P.panel_single_glazed_diffuse_transmissions[i];

  direct_flux_after_2_layer_NIR = direct_flux_after_1_layer_NIR*solarGreenhouseV2.Functions.Direct_2interface( P.n_index, P.panel_azimuths[i],  P.panel_zeniths[i], sun_azimuth, sun_zenith)*( 1 - P.haze);
  diffuse_flux_after_2_layer_NIR= direct_flux_after_1_layer_NIR*solarGreenhouseV2.Functions.Direct_2interface( P.n_index, P.panel_azimuths[i],  P.panel_zeniths[i], sun_azimuth, sun_zenith)*(P.haze) +
    diffuse_flux_after_1_layer_NIR*P.panel_single_glazed_diffuse_transmissions[i];




  diffuse_power_transmitted_PAR =
    P.panel_areas[i]*(1 - P.panel_structural_fractions[i])*( diffuse_flux_after_2_layer_PAR*(P.panel_double_glazed_fractions[i]) + diffuse_flux_after_1_layer_PAR*(1-P.panel_double_glazed_fractions[i]));
  direct_power_transmitted_PAR =
    P.panel_areas[i]*(1 - P.panel_structural_fractions[i])*( direct_flux_after_2_layer_PAR*(P.panel_double_glazed_fractions[i]) + direct_flux_after_1_layer_PAR*(1-P.panel_double_glazed_fractions[i]));

  diffuse_power_transmitted_NIR =
    P.panel_areas[i]*(1 - P.panel_structural_fractions[i])*( diffuse_flux_after_2_layer_NIR*(P.panel_double_glazed_fractions[i]) + diffuse_flux_after_1_layer_NIR*(1-P.panel_double_glazed_fractions[i]));
  direct_power_transmitted_NIR =
    P.panel_areas[i]*(1 - P.panel_structural_fractions[i])*( direct_flux_after_2_layer_NIR*(P.panel_double_glazed_fractions[i]) + direct_flux_after_1_layer_NIR*(1-P.panel_double_glazed_fractions[i]));


  transmitted_PAR = (1-blanket_fraction)*(direct_power_transmitted_PAR + diffuse_power_transmitted_PAR);
  absorbed_PAR = (1-blanket_fraction)*(direct_power_transmitted_PAR + diffuse_power_transmitted_PAR)*P.panel_structural_fractions[i]/( 1 - P.panel_structural_fractions[i]);

  transmitted_NIR = (1-blanket_fraction)*(direct_power_transmitted_NIR + diffuse_power_transmitted_NIR);
  absorbed_NIR = (1-blanket_fraction)*(direct_power_transmitted_NIR + diffuse_power_transmitted_NIR)*P.panel_structural_fractions[i]/( 1 - P.panel_structural_fractions[i]);
